...
class Checkbook {
  ...
  public void withdrawMoney(double amount) {
    if (amount <= balance) {
      ...
      System.out.println(
        "Insufficient funds. Unable to withdraw amount: " + amount
      );
    }
  }
}
  ...
  void Re_Activate(int M) {
    if (is_dormant) {
      if (M + getBalance() >= getMinimum_balance()) {
        ...
        System.out.println(
          "Please Enter Enough amount to Re-Activate the Account"
        );
      }
    } else {
    ...
    for (int i = 0; i < transactions.size(); i++) {
      if (
        transactions
          ...
          .get(i)
          .getAccount_Number()
          .equals(accounts.getAccount_Number())
      ) {
        idx = i;
        System.out.println(
          "Transaction on :" + transactions.get(i).getDates().get(i).toString()
        );
        System.out.println(
          "Balance :" + transactions.get(i).getAccounts().get(i).getBalance()
        );
      }
      System.out.println(
        "------------------------------------------------------------------------------------------"
...
class Bank {
            ...
            while (crd > 3 || crd < 1) {
              ...
              switch (crd) {
                case 1 -> {
                  ...
                  while (str != "1234") {
                    System.out.println(
                      "Your Card Number is Incorrect Please Enter Valid Card Number:"
                    );
                    str = input.next();
                  }
  ...
  void Transaction_Details() {
    for (int i = 0; i < transactionLedgers.size(); i++) {
      System.out.println(
        "Account Type   :" +
        transactionLedgers.get(i).getAccounts().get(i).getAccount_type()
      );
      System.out.println(
        "Account Number :" +
        transactionLedgers.get(i).getAccounts().get(i).getAccount_Number()
      );
      System.out.println(
        "Account Balance :" +
        transactionLedgers.get(i).getAccounts().get(i).getBalance()
      );
      System.out.println(
        "Transaction Date:" +
        transactionLedgers.get(i).getDates().get(i).toString()
      );
    }
  }
  ...
  void Customer_Details() {
    ...
    for (int i = 0; i < users.size(); i++) {
      ...
      System.out.println(
        "University id :" + users.get(i).getUniversity_Id_Number()
      );
      System.out.println(
        "No of Accounts:" + users.get(i).getNumber_of_Accounts()
      );
    }
  }
  ...
  void Account_Details() {
    ...
    for (int i = 0; i < accounts.size(); i++) {
      System.out.println(
        "Account Type                 :" + accounts.get(i).getAccount_type()
      );
      System.out.println(
        "Account Number               :" + accounts.get(i).getAccount_Number()
      );
      System.out.println(
        "Account ID                   :" + accounts.get(i).getAccount_ID()
      );
      System.out.println(
        "Account Balance              :" + accounts.get(i).getBalance()
      );
      System.out.println(
        "Account Minimum Balance limit:" + accounts.get(i).getMinimum_balance()
      );
    }
  }
}
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      System.out.println(
        "---------------------Welcome to RIPHAH Banking System----------------------------"
      );
      ...
      if (opt2 == 1) {
        System.out.println(
          "__________________LogIn As Manager_____________________________"
        );
        ...
        System.out.println(
          "__________________LogIn As Customer_____________________________"
        );
